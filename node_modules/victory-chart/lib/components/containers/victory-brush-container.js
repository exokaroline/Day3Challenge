...
var brushContainerMixin = exports.brushContainerMixin = function (base) {
  var _class, _temp;
  ...
  return _temp = _class = function (_base) {
    ...
    _createClass(VictoryBrushContainer, [{
      ...
      value: function getRect(props) {
        ...
        var domain = (0, _reactFastCompare2.default)(brushDomain, cachedBrushDomain) ? (0, _defaults3.default)({}, currentDomain, brushDomain) : brushDomain;
        ...
        return selectBox ? _react2.default.createElement(
          "g",
          null,
          selectBox,
